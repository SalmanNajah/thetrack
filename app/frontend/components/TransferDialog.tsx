...
export function TransferDialog({
  ...
  const buttonClass = isSm
    ? "flex items-center gap-1.2 rounded-xl border border-tt-border bg-tt-surface px-2.5 py-1 text-[11px] font-base text-tt-text-tertiary hover:text-tt-text hover:border-tt-text-tertiary/40 transition-colors focus:outline-none active:scale-[0.97] cursor-pointer gap-2"
    : "flex items-center gap-1.5 rounded-xl border border-tt-border bg-tt-surface px-3.5 py-1.5 text-[13px] font-base text-tt-text-tertiary hover:text-tt-text hover:border-tt-text-tertiary/40 transition-colors focus:outline-none active:scale-[0.97] cursor-pointer gap-2"
